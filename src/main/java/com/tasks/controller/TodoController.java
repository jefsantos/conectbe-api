...
import com.tasks.services.TodoService;
...
public class TodoController {
	...
	@GetMapping(value = "/quantidadeServicos")
	public ResponseEntity<List<Long>> countServices(){
		List<Long> list = service.countServices();
		return ResponseEntity.ok().body(list);
	}
	
	@GetMapping(value = "/closed")
	public ResponseEntity<List<Todo>> listClosed() {
		List<Todo> list = service.findAllCloded();
